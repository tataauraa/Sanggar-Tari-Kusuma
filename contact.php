...
<body>
    ...
    <section class="Contact">
        <div class="content">
            <h2>Contact Us</h2>
            <p>"Terdapat pertanyaan, saran, atau ingin berkolaborasi? Jangan ragu untuk menghubungi kami di Contact Us!
                Kami siap melayani dengan senang hati."</p>
        </div>
        <div class="Container">
            <div class="contactinfo">
                <div class="box">
                    ...
                    <div class="text">
                        <h3>Address</h3>
                        <p>Jl. Pahlawan No. 123,<br>Malang, Jawa Timur</p>
                    </div>
                </div>
            </div>
            <div class="box">
